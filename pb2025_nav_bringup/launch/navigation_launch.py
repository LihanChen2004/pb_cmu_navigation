...
def generate_launch_description():
    ...
    start_sensor_scan_generation_cmd = Node(
    ...
    ld.add_action(start_loam_interface_cmd)
    ld.add_action(start_sensor_scan_generation_cmd)
